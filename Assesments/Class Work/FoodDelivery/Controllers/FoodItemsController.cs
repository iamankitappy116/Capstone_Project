...
namespace FoodDelivery.Controllers
{
    public class FoodItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FoodItemId,Name,Price,RestaurantId")] FoodItem foodItem)
        {
            ...
            ViewData["RestaurantId"] = new SelectList(_context.Restaurants, "RestaurantId", "Name", foodItem.RestaurantId);
            return View(foodItem);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FoodItemId,Name,Price,RestaurantId")] FoodItem foodItem)
        {
